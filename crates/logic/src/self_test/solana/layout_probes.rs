...
register_self_test! {
    ...
    fn iter_static_table_lookup() -> u32 {
...
register_self_test! {
    ...
    fn iter_mut_alphabet_lookup() -> u32 {
...
register_self_test! {
    ...
    fn iter_static_slice_lookup() -> u32 {
