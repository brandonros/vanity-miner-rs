...
pub use logic::self_test::runners::p256_public_key::kernel_self_test_p256_public_key;
...
mod tests {
    ...
    fn original_checks_and_slot_selection_preserve_guards() {
        ...
        for selector in [
            ...
            unsafe {
                kernel_self_test_p256_public_key(&selector, results.as_mut_ptr().add(1).cast())
            };
