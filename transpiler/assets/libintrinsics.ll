...
define i32 @__nvvm_atomic_add_global_i32(i32* %ptr, i32 %val) #0 {
start:
  %0 = call i32 asm sideeffect "atom.global.add.u32 $0, [$1], $2;", "=r,l,r"(i32* %ptr, i32 %val)
  ret i32 %0
}

declare i32 @llvm.nvvm.atomic.add.gen.i.global.i32.p0i32(i32*, i32) #1
