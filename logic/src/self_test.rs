...
// Public known-answer fixtures; runtime barriers precede the operations under test.
// Public fixture constants are kept with the checks below.
use core::hint::black_box;

pub fn check_p256_public_key_hmac_derivation() -> u32 {
    u32::from((|| {
        let d = crate::crypto_search::CandidateDeriver::new(
            black_box([0x42; 32]),
            crate::crypto_search::CandidateDomain::P256PrivateKey,
            [0; 32],
            [0; 32],
        );
...
pub fn check_p256_public_key_scalar_derivation() -> u32 {
    u32::from((|| {
        ...
        crate::p256_vanity::candidate_scalar(&d, black_box(3), black_box(4))
...
pub fn check_p256_public_key_generator() -> u32 {
    u32::from((|| {
        let mut scalar = [0; 32];
        scalar[31] = 1;
        crate::p256_vanity::public_point(&black_box(scalar)) == Some(CRYPTO_FIXTURE_P256_GENERATOR)
    })())
}
...
pub fn check_p256_public_key_point_double() -> u32 {
    u32::from((|| {
        let mut scalar = [0; 32];
        scalar[31] = 2;
        crate::p256_vanity::public_point(&black_box(scalar)) == Some(CRYPTO_FIXTURE_P256_DOUBLE)
    })())
}

pub fn check_p256_public_key_zero_scalar_rejected() -> u32 {
    u32::from((|| {
        crate::p256_vanity::public_point(&black_box([0; 32])).is_none()
    })())
}

pub fn check_p256_public_key_order_scalar_rejected() -> u32 {
    u32::from((|| {
        crate::p256_vanity::public_point(&black_box(CRYPTO_FIXTURE_P256_ORDER)).is_none()
    })())
}

pub fn check_p256_public_key_x_encoding() -> u32 {
    u32::from((|| {
        crate::p256_vanity::PublicTarget::X.bytes(&black_box(CRYPTO_FIXTURE_P256_GENERATOR))
...
pub fn check_p256_public_key_y_encoding() -> u32 {
    u32::from((|| {
        crate::p256_vanity::PublicTarget::Y.bytes(&black_box(CRYPTO_FIXTURE_P256_GENERATOR))
...
pub fn check_p256_signature_rfc6979_sample() -> u32 {
    u32::from((|| {
        crate::p256_vanity::signatures::sign_message(
...
pub fn check_p256_signature_rfc6979_test() -> u32 {
    u32::from((|| {
        crate::p256_vanity::signatures::sign_message(&black_box(CRYPTO_FIXTURE_RFC6979_KEY), black_box(b"test"))
...
pub fn check_p256_signature_ephemeral_r() -> u32 {
    u32::from((|| {
        let mut nonce = [0; 32];
        nonce[31] = 1;
        crate::p256_vanity::signatures::ephemeral_r(&black_box(nonce))
...
pub fn check_p256_signature_ephemeral_signature() -> u32 {
    u32::from((|| {
        let mut one = [0; 32];
        one[31] = 1;
        crate::p256_vanity::signatures::sign_digest_ephemeral(
            &black_box(one),
...
pub fn check_p256_signature_low_s() -> u32 {
    u32::from((|| {
        use crate::p256_vanity::signatures::{SForm, SignatureTarget, matching_representation};
        let pattern = crate::hex_pattern::HexPattern::new("", "", 64).unwrap();
...
pub fn check_p256_signature_message_window_carry() -> u32 {
    u32::from((|| {
        crate::crypto_search::hash_message_counter(
...
pub fn check_p256_signature_ephemeral_hmac() -> u32 {
    u32::from((|| {
        let d = crate::crypto_search::CandidateDeriver::new(
            black_box([0x42; 32]),
            crate::crypto_search::CandidateDomain::P256Ephemeral,
            [1; 32],
            [2; 32],
        );
...
pub fn check_rsa_pss_mgf1_partial_block() -> u32 {
    u32::from((|| {
        let mut out = [0; 50];
        crate::rsa_pss::mgf1_sha256(black_box(b"public test seed"), &mut out).is_ok()
...
pub fn check_rsa_pss_salt32_encoding() -> u32 {
    u32::from((|| {
        ...
        let mut out = [0; 256];
        crate::rsa_pss::encode_sha256(&black_box(CRYPTO_FIXTURE_SAMPLE_SHA256), &salt, 2047, &mut out).is_ok()
...
pub fn check_rsa_pss_oversized_salt_rejected() -> u32 {
    u32::from((|| {
        ...
        crate::rsa_pss::encode_sha256(
            &black_box(CRYPTO_FIXTURE_SAMPLE_SHA256),
            &black_box([0; 223]),
            2047,
            &mut out,
        ) == Err(crate::rsa_pss::PssError::SaltTooLong)
            && out == [0xa5; 256]
    })())
}
...
pub fn check_rsa_pss_salt_carry() -> u32 {
    u32::from((|| {
        let mut out = [0; 2];
        crate::crypto_search::write_salt_counter(&black_box([0xff; 2]), black_box(1), &mut out)
            .is_ok()
            && out == [0; 2]
    })())
}
...
pub fn check_rsa_pss_crt_fault_rejected() -> u32 {
    ...
    let key = crate::rsa_crt::Rsa2048Crt::new(
        &black_box([255; 128]), &black_box(SELF_TEST_RSA_Q),
        &black_box(SELF_TEST_COMPOSITE_DP), &black_box(SELF_TEST_RSA_DQ),
        &black_box(SELF_TEST_COMPOSITE_Q_INV),
    ).unwrap();
    let mut input = [0; 256]; input[255] = 65;
...
pub fn check_rsa_modulus_prime_filter() -> u32 {
    u32::from((|| {
        crate::rsa_prime::probable_prime(&black_box(crypto_bigint::U1024::from_u64(104729)))
    })())
}

pub fn check_rsa_modulus_pseudoprime_rejected() -> u32 {
    u32::from((|| {
        !crate::rsa_prime::probable_prime(&black_box(crypto_bigint::U1024::from_u64(
            341550071728321,
        )))
    })())
}
...
pub fn check_rsa_modulus_zero_stride_rejected() -> u32 {
    u32::from((|| {
        use crate::rsa_modulus_vanity::{RsaModulusRequest, rsa_modulus};
        ...
        let pattern = crate::hex_pattern::HexPattern::new("", "", 256).unwrap();
...
const SELF_TEST_RSA_Q_INV: [u8; 128] = [
...
fn record_candidate(h: &mut sha2::Sha256, result: crate::candidate_result::CandidateResult) {
    use sha2::Digest;
...
fn self_test_digest_p256_public() -> [u8; 32] {
    use crate::{hex_pattern::HexPattern, p256_public_key_vanity::*};
    use sha2::{Digest, Sha256};
...
fn self_test_digest_p256_signature() -> [u8; 32] {
    use crate::{hex_pattern::HexPattern, p256_signature_vanity::*};
    use sha2::{Digest, Sha256};
    let mut h = Sha256::new();
    let mut private = [0; 32];
    private[31] = 1;
    let public = crate::p256_vanity::public_point(&black_box(private)).unwrap();
...
fn self_test_digest_rsa_pss() -> [u8; 32] {
    use crate::{hex_pattern::HexPattern, rsa_pss_signature_vanity::*};
    use sha2::{Digest, Sha256};
    let mut h = Sha256::new();
    let message = black_box(b"header\0\0footer");
    for source in [0, 1] {
...
fn self_test_digest_rsa_modulus() -> [u8; 32] {
    use crate::{hex_pattern::HexPattern, rsa_modulus_vanity::*};
...
const CRYPTO_FIXTURE_P256_ORDER: [u8; 32] = [
    0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xbc, 0xe6, 0xfa, 0xad, 0xa7, 0x17, 0x9e, 0x84, 0xf3, 0xb9, 0xca, 0xc2, 0xfc, 0x63, 0x25, 0x51,
];
const CRYPTO_FIXTURE_P256_GENERATOR: [u8; 65] = [
...
const CRYPTO_FIXTURE_P256_DOUBLE: [u8; 65] = [
...
const CRYPTO_FIXTURE_PRIVATE_DERIVATION: [u8; 32] = [
...
const CRYPTO_FIXTURE_EPHEMERAL_DERIVATION: [u8; 32] = [
...
const CRYPTO_FIXTURE_SAMPLE_SHA256: [u8; 32] = [
...
const CRYPTO_FIXTURE_MGF_PARTIAL: [u8; 50] = [
...
const CRYPTO_FIXTURE_PSS_SALT32: [u8; 256] = [
...
const CRYPTO_FIXTURE_PSS_EMPTY_SALT: [u8; 256] = [
...
const CRYPTO_FIXTURE_PSS_MAX_SALT: [u8; 256] = [
...
const CRYPTO_FIXTURE_RFC6979_KEY: [u8; 32] = [
    0xc9, 0xaf, 0xa9, 0xd8, 0x45, 0xba, 0x75, 0x16, 0x6b, 0x5c, 0x21, 0x57, 0x67, 0xb1, 0xd6, 0x93,
    0x4e, 0x50, 0xc3, 0xdb, 0x36, 0xe8, 0x9b, 0x12, 0x7b, 0x8a, 0x62, 0x2b, 0x12, 0x0f, 0x67, 0x21,
];
const CRYPTO_FIXTURE_RFC6979_SAMPLE: [u8; 64] = [
...
const CRYPTO_FIXTURE_RFC6979_TEST: [u8; 64] = [
...
const CRYPTO_FIXTURE_RFC6979_SAMPLE_LOW: [u8; 64] = [
    0xef, 0xd4, 0x8b, 0x2a, 0xac, 0xb6, 0xa8, 0xfd, 0x11, 0x40, 0xdd, 0x9c, 0xd4, 0x5e, 0x81, 0xd6,
    0x9d, 0x2c, 0x87, 0x7b, 0x56, 0xaa, 0xf9, 0x91, 0xc3, 0x4d, 0x0e, 0xa8, 0x4e, 0xaf, 0x37, 0x16,
...
const CRYPTO_FIXTURE_EPHEMERAL_ONE: [u8; 64] = [
...
const CRYPTO_FIXTURE_WINDOW_SHA256: [u8; 32] = [
...
const CRYPTO_FIXTURE_MUL_CARRY: [u8; 256] = [
...
const CRYPTO_FIXTURE_PROGRESSION_CARRY: [u8; 256] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const SELF_TEST_RSA_SIGNATURE_65: [u8; 256] = [145, 162, 206, 34, 122, 227, 57, 37, 205, 20, 210, 159, 102, 220, 164, 49, 178, 249, 56, 23, 108, 141, 192, 216, 87, 218, 146, 161, 191, 146, 9, 153, 51, 173, 32, 128, 181, 117, 63, 70, 98, 219, 8, 116, 155, 160, 27, 37, 225, 192, 236, 69, 41, 22, 125, 166, 12, 153, 33, 45, 13, 54, 217, 29, 139, 151, 105, 11, 20, 186, 212, 47, 139, 147, 164, 171, 193, 181, 96, 75, 2, 115, 165, 207, 192, 75, 235, 124, 3, 113, 225, 75, 221, 179, 103, 100, 65, 42, 191, 24, 7, 243, 113, 92, 250, 230, 209, 139, 78, 106, 232, 65, 29, 168, 20, 221, 196, 66, 192, 140, 13, 184, 218, 223, 232, 25, 182, 213, 232, 253, 176, 80, 151, 150, 22, 23, 155, 237, 205, 73, 9, 235, 71, 39, 230, 244, 57, 71, 169, 112, 4, 63, 210, 197, 46, 177, 50, 35, 193, 92, 10, 41, 75, 215, 211, 221, 25, 238, 128, 111, 224, 239, 82, 147, 61, 121, 193, 223, 108, 6, 27, 173, 113, 140, 106, 67, 123, 105, 250, 33, 81, 128, 150, 87, 228, 225, 189, 49, 226, 241, 56, 46, 252, 228, 113, 163, 149, 118, 160, 25, 152, 151, 82, 104, 54, 142, 210, 240, 63, 32, 115, 71, 171, 178, 82, 93, 186, 36, 150, 147, 203, 110, 44, 213, 164, 45, 195, 32, 86, 98, 57, 243, 221, 155, 51, 157, 196, 85, 170, 47, 103, 4, 91, 144, 73, 87];

const SELF_TEST_COMPOSITE_DP: [u8; 128] = [0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255];

const SELF_TEST_COMPOSITE_Q_INV: [u8; 128] = [232, 113, 37, 66, 119, 169, 161, 25, 107, 74, 24, 49, 150, 186, 13, 197, 215, 32, 170, 74, 96, 137, 201, 28, 149, 174, 221, 216, 83, 92, 118, 97, 156, 90, 233, 36, 38, 222, 96, 32, 197, 110, 59, 3, 161, 229, 44, 208, 95, 163, 19, 94, 74, 101, 155, 115, 152, 32, 68, 151, 242, 148, 31, 234, 254, 232, 140, 21, 158, 177, 246, 99, 114, 114, 139, 253, 42, 34, 110, 7, 54, 26, 135, 208, 33, 26, 251, 197, 223, 25, 214, 246, 103, 89, 227, 202, 144, 2, 237, 213, 31, 139, 40, 109, 130, 51, 246, 225, 12, 88, 122, 61, 234, 96, 200, 254, 18, 235, 170, 64, 53, 84, 183, 204, 57, 138, 89, 177];

fn self_test_crt_key() -> crate::rsa_crt::Rsa2048Crt {
    crate::rsa_crt::Rsa2048Crt::new(
        &black_box(SELF_TEST_RSA_P), &black_box(SELF_TEST_RSA_Q),
        &black_box(SELF_TEST_RSA_DP), &black_box(SELF_TEST_RSA_DQ),
