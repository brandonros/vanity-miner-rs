//! Original search-mode pipeline checks.
use crate::{
    modes::bitcoin_vanity::BitcoinVanityKeyRequest, modes::bitcoin_vanity::BitcoinVanityKeyResult,
    modes::bitcoin_vanity::generate_and_check_bitcoin_vanity_key,
    modes::bitcoin_vanity::private_key_to_wif, modes::ethereum_vanity::EthereumVanityKeyRequest,
    modes::ethereum_vanity::EthereumVanityKeyResult,
    modes::ethereum_vanity::generate_and_check_ethereum_vanity_key,
    modes::shallenge::ShallengeRequest, modes::shallenge::ShallengeResult,
    modes::shallenge::compare_hashes, modes::shallenge::generate_and_check_shallenge,
    modes::solana_vanity::SolanaVanityKeyRequest, modes::solana_vanity::SolanaVanityKeyResult,
    modes::solana_vanity::generate_and_check_solana_vanity_key,
};
...
pub fn check_ethereum_priv() -> u32 {
    let expected: [u8; 32] = [
        ...
        0xa1, 0x6b, 0xf6, 0x3b, 0x69, 0x71, 0x66, 0x33, 0xe9, 0xbf, 0xe7, 0x9a, 0x98, 0x13, 0xc4,
        0x05, 0xab,
    ];
...
pub fn check_shallenge_hash() -> u32 {
    let expected: [u8; 32] = [
        ...
        0x4e, 0x6f, 0xde, 0x67, 0x0a, 0xd8, 0xa3, 0xe2, 0xa6, 0x00, 0xa0, 0xe0, 0xb7, 0x35, 0x76,
        0x54, 0xc9,
    ];
