...
mod test {
    ...
    fn should_hash_correctly() {
        ...
        let private_key: [u8; 32] =
            hex::decode("61a314b0183724ea0e5f237584cb76092e253b99783d846a5b10db155128eafd")
                .unwrap()
                .try_into()
                .unwrap();
        let hashed_private_key_bytes =
            crate::crypto::sha512::sha512_32bytes_from_bytes(&private_key);
