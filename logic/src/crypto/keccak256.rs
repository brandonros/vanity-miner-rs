...
mod test {
    ...
    fn should_hash_correctly() {
        ...
        let hashed_private_key_bytes = crate::crypto::keccak256::keccak256_64bytes(&private_key);
        let expected =
            hex::decode("0f439a9830558b9cd6842328dd11585401c34321a53b29422aacde310643d373")
                .unwrap();
