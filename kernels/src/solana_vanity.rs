...
unsafe fn handle_solana_vanity_match_found(
    result: logic::SolanaVanityKeyResult,
    thread_idx: usize,
...
pub unsafe extern "C" fn kernel_find_solana_vanity_private_key(
    // input
    ...
    if result.matches {
        unsafe { 
            handle_solana_vanity_match_found(
                result,
                thread_idx,
